...
export const Route = createFileRoute("/help-center")({
  head: () => ({
    meta: [
      { title: "Help Center — Klyro" },
      { name: "description", content: "Answers to common questions for engineers and founders using Klyro." },
    ],
  }),
  ...
  return (
    ...
    >
      <InfoBlock title="How does vetting work?">
        Every engineer who applies to Klyro is reviewed manually. We look at GitHub activity, real
        project work, and have a short conversation before assigning a Klyro Score. Nothing is
      ...
      <InfoBlock title="Is Klyro free for engineers?">
      ...
      <InfoBlock title="What kind of roles are on Klyro?">
      ...
      <InfoBlock title="I still have a question">
        Email <a className="underline" href="mailto:hello@klyro.dev">hello@klyro.dev</a> and a real
